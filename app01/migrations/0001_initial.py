# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-04 11:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.ClassList')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('pwd', models.CharField(max_length=32, unique=True, verbose_name='密码')),
                ('classlist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.ClassList')),
            ],
        ),
        migrations.CreateModel(
